...
function ProductDescription(props) {
  ...
  function galleryShow(source, tagname, banner) {
  ...
  function viewGallery(section = null) {
    return (
              ...
              {props.product !== undefined
                ? props.product.productDescription.map((description) =>
                    description.type === 5 ? (
                      ...
                      <div className="tab-pane" id="enhanced-manufacturer-overview-section" key={description.type}>
                        {Parser(description.description)}
                      </div>
                    ) : (
                      ''
